...
function Navbar() {
  ...
  return (
    <div className=''>
    <div  className={`h-full bg-black/60 backdrop-blur-sm right-0 drop-shadow-2xl duration-700 top-0 ${isToggle ? " w-9/12 absolute " : "w-[200px] hidden opacity-0"}   z-50 min-sm:hidden ` }>
